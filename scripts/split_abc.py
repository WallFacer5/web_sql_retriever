...
if __name__ == '__main__':
    ...
    employee.to_csv('/Users/wallfacer/Documents/employee.txt', sep='\t')
    product.to_csv('/Users/wallfacer/Documents/product.txt', index=None, sep='\t')
    customer.to_csv('/Users/wallfacer/Documents/customer.txt', index=None, sep='\t')
    order.to_csv('/Users/wallfacer/Documents/order.txt', index=None, sep='\t')
    order_products.to_csv('/Users/wallfacer/Documents/order_products.txt', index=None, sep='\t')
